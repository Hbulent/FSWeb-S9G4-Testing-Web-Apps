...
test("kullanıcı doğru ad ve soyad girdiğinde ama email girmediğinde BİR hata mesajı render ediliyor.", async () => {
  ...
  userEvent.type(EmailkullaniciAdi, "Bülent");
  userEvent.type(kullaniciSoyadi, "B.");
...
test("ad,soyad, email render ediliyor. mesaj bölümü doldurulmadığında hata mesajı render edilmiyor.", async () => {
  ...
  userEvent.type(kullaniciAdi, "Bülent");
  userEvent.type(kullaniciSoyadi, "Hacıosmanoğlu");
  userEvent.type(Email, "bulenthaciosmanoglu@gmail.com");
...
test("form gönderildiğinde girilen tüm değerler render ediliyor.", async () => {
  ...
  userEvent.type(nameInput, "Bülent");
  userEvent.type(surnameInput, "Hacıosmanoğlu");
  userEvent.type(emailInput, "bulenthaciosmanoglu@gmail.com");
  const submitButton = screen.getByText(/Gönder/);
  userEvent.click(submitButton);
  await waitFor(() => {
    ...
    expect(displayNameInput).toHaveTextContent("Bülent");
    expect(displaySurnameInput).toHaveTextContent("Hacıosmanoğlu");
    expect(displayEmailInput).toHaveTextContent(
      "bulenthaciosmanoglu@gmail.com"
    );
  });
});
